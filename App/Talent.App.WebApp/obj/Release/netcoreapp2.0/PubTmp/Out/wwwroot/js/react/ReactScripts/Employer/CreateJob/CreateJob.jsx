...
export default class CreateJob extends React.Component {
    ...
    loadData() {
        ...
        if (param != "" || copyJobParam != "") {
            var link = param != "" ? 'https://talentservicestalentcompetition.azurewebsites.net/listing/listing/GetJobByToEdit?id=' + param
                : 'https://talentservicestalentcompetition.azurewebsites.net/listing/listing/GetJobForCopy?id=' + copyJobParam;
    ...
    addUpdateJob() {
        ...
        var cookies = Cookies.get('talentAuthToken');   
        $.ajax({
            url: 'https://talentservicestalentcompetition.azurewebsites.net/listing/listing/createUpdateJob',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
